...
import org.urx.service.helper.EntityParse
import org.urx.service.helper.ProtectFields
import org.urx.service.helper.SingleValidation
import org.urx.service.helper.Validation
import org.urx.service.helper.Validations
...
class Request: LinkedHashMap<String, Any?>() {
	...
	fun <T> to(key: String, singleValidation: SingleValidation?): T {
		...
		if (org.pechblenda.exception.service.helper.Type.isUUID(value.toString())) {
